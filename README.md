...
int main() {
    ...
    printf("Enter Madhu's private key: ");
    scanf("%lld", &privateA);
    printf("Enter divi's private key: ");
    scanf("%lld", &privateB);
    ...
    printf("Madhu's public key: (%lld, %lld)\n", publicA.x, publicA.y);
    printf("divi's public key: (%lld, %lld)\n", publicB.x, publicB.y);
    ...
    printf("Shared secret computed by Madhu: (%lld, %lld)\n", sharedSecretA.x, sharedSecretA.y);
    printf("Shared secret computed by divi: (%lld, %lld)\n", sharedSecretB.x, sharedSecretB.y);
...
<img width="1532" height="777" alt="image" src="https://github.com/user-attachments/assets/f851e12f-75e7-4b71-9d74-ae6551044ffa" />
